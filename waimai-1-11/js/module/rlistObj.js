	...
	load_banner:function(){
		...
		$.ajax({
			...
			success:function(res){
				...
				$('.swiper-wrapper').width(_this.clientWidth * _this.num+ 'px');*/
	...
	loadSj:function(loc,onOff){
		...
		$.ajax({
			...
			success:function(res){
				...
				// 字符串拼接
					str += '<a class="rl-item" href="#detail-'+ res[i].id +'-'+ res[i].latitude +'-'+ res[i].longitude +'">	\
								<div class="rl-item-l">\
